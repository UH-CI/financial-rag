...
const FiscalNoteGeneration = () => {
  ...
  if (isMobile) {
    ...
    return (
      <div className="h-screen w-screen bg-gray-50 overflow-auto scroll-smooth mobile-scroll pb-20">
    ...
    <div className="flex h-screen w-screen bg-gray-50 overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {selectedFiscalNote && useNewViewer ? (
          ...
          <div className="flex-1 overflow-auto scroll-smooth mobile-scroll p-6">
            {loadingFiscalNote && (
